...
public class LoginServiceLocator extends org.apache.axis.client.Service implements project.LoginService {
    ...
    private java.lang.String Login_address = "http://localhost:8080/Blog_Web/services/Login";
    ...
    public project.Login getLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            project.LoginSoapBindingStub _stub = new project.LoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (project.Login.class.isAssignableFrom(serviceEndpointInterface)) {
                project.LoginSoapBindingStub _stub = new project.LoginSoapBindingStub(new java.net.URL(Login_address), this);
                _stub.setPortName(getLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Project", "LoginService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Project", "Login"));
        }
